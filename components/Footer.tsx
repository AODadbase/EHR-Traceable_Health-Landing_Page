    ...
    <footer className="bg-slate-900 text-white py-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
          ...
          <a href="mailto:traceablehealth@gmail.com" className={`inline-flex items-center gap-2 text-sm mt-4 transition-colors ${
            isDark ? 'text-purple-400 hover:text-purple-300' : 'text-blue-400 hover:text-blue-300'
          }`}>
            <Mail size={16} />
